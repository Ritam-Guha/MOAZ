...
std::vector <std::pair<IntegerT, IntegerT>> Mutator::get_algo_len_limits(){
	std::vector <std::pair<IntegerT, IntegerT>> algo_len;

	algo_len.push_back(std::pair<IntegerT, IntegerT> (setup_size_min_, setup_size_max_));
	algo_len.push_back(std::pair<IntegerT, IntegerT> (learn_size_min_, learn_size_max_));
	algo_len.push_back(std::pair<IntegerT, IntegerT> (predict_size_min_, predict_size_max_));
...
//  std::cout << "setup limits=> " << setup_size_min_ << ":" << setup_size_max_ << ", learn limits=> " << learn_size_min_ << ":" << learn_size_max_ << ", predict limits=> " << predict_size_min_ << ":" << predict_size_max_ << std::endl;
  switch (ComponentFunction()) {
    case kSetupComponentFunction: {
