...
constexpr int CARTPOLE_TASK = 1;
constexpr int ACROBOT_TASK = 2;
constexpr int CARTCENTERING_TASK = 3;
constexpr int PENDULUM_TASK = 4;
constexpr int MOUNTAINCAR_TASK = 5;
constexpr int MOUNTAINCAR_CONTINUOUS_TASK = 6;

constexpr int CONTROL_TASK = 3;

constexpr bool PARTIALLY_OBSERVABLE = false;
...
constexpr uint8_t MATRIX_TYPE = 2;
constexpr uint8_t NA_TYPE = 3;
