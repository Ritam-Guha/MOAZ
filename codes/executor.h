   ...
   template <FeatureIndexT F>
      class Executor {
         ...
         private:
            ...
            const std::string type_problem_;
      };
   ...
   template <FeatureIndexT F>
      double Executor<F>::Execute(std::vector<double>* train_errors,
         ...
         while (num_remaining > 0) {
            ...
            if(type_problem_ == "control_tasks"){
               current_fitness = ValidateControl(valid_errors);
            }
            else if(type_problem_ == "linear_regression"){
   ...
   template <FeatureIndexT F>
      bool Executor<F>::Train(const IntegerT max_steps, std::vector<double>* errors,
         ...
         CHECK(errors == nullptr || max_steps <= 100) <<
            ...
            << std::endl;
         if (type_problem_ == "control_tasks")
            return TrainNoOptImplControl(max_steps, errors, train_it);
         else if(type_problem_ == "linear_regression"){
