...
bazel run --sandbox_debug -c opt \
  ...
  --search_experiment_spec=" \
    ...
    predict_ops: [SCALAR_CONST_SET_OP, VECTOR_INNER_PRODUCT_OP, SCALAR_DIFF_OP, SCALAR_PRODUCT_OP, SCALAR_VECTOR_PRODUCT_OP, VECTOR_SUM_OP, VECTOR_OUTER_PRODUCT_OP, VECTOR_NORM_OP, VECTOR_UNIFORM_SET_OP] \
    learn_ops: [SCALAR_CONST_SET_OP, VECTOR_INNER_PRODUCT_OP, SCALAR_DIFF_OP, SCALAR_PRODUCT_OP, SCALAR_VECTOR_PRODUCT_OP, VECTOR_SUM_OP, VECTOR_OUTER_PRODUCT_OP, VECTOR_NORM_OP, VECTOR_UNIFORM_SET_OP] \
    setup_size_init: 5 \
    predict_size_init: 15 \
    learn_size_init: 20 \
    ...
    mutate_predict_size_min : 10\
    mutate_predict_size_max : 20\
    mutate_learn_size_min : 10\
    mutate_learn_size_max : 30\
    mutate_prob: 1.0 \
