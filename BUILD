...
cc_library(
    name = "compute_cost_new",
    srcs = ["compute_cost_new.cc"],
    hdrs = ["compute_cost_new.h"],
    deps = [
        ":algorithm",
        ":instruction",
        ":instruction_cc_proto",
...
cc_binary(
    name = "run_search_experiment_re",
    srcs = ["run_search_experiment_re.cc"],
    deps = [
        ":algorithm",
        ":dataset_util",
        ":datasets_cc_proto",
...
cc_binary(
    name = "run_search_experiment_nsga2",
    srcs = ["run_search_experiment_nsga2.cc"],
    deps = [
        ":algorithm",
        ":dataset_util",
        ":datasets_cc_proto",
